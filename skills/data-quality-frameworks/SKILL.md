...
description: "Data quality validation with Great Expectations, dbt tests, and data contracts. Use when building formal validation rules, expectation suites, or data contracts for repeatable quality gates."
disable-model-invocation: true
---

# Data Quality Frameworks

Production patterns for implementing data quality validation with Great Expectations, dbt tests, and data contracts to ensure reliable data pipelines.

**Role in the ds plugin:** This skill is invoked by `/ds:validate` as the primary reference for building and running formal data quality validation. It is also referenced by `/ds:eda` for quality dimension analysis and by `/ds:review` for data quality audit evidence. It provides enterprise-grade validation framework patterns complementing the `data-preprocessing` skill (which provides lightweight pandas-based schema validation in `references/data_validation_schemas.md` for quick preprocessing checks). For pre-model data cleaning, deduplication, and structural validation, use the `data-preprocessing` skill. For descriptive data profiling (distributions, anomalies, statistics), use the `data-profiler` agent. This skill focuses on formal, reusable, versioned quality gates using Great Expectations, dbt, and data contracts.

## When to Use This Skill

Use this skill when:

- Setting up formal data quality validation with expectation suites
- Implementing Great Expectations checkpoints and validation pipelines
- Building comprehensive dbt test suites for warehouse data
- Establishing data contracts between data producers and consumers
- Monitoring data quality metrics over time
- Automating data validation in CI/CD pipelines
- Creating reusable, versioned validation rules

Do NOT use this skill for:

- Pre-model data cleaning and transformation -- use the `data-preprocessing` skill
- Quick pandas-based schema validation during preprocessing -- use the `data-preprocessing` skill's `references/data_validation_schemas.md`
- Data profiling and characterization -- use the `data-profiler` agent
- In-model preprocessing (scaling, encoding inside sklearn Pipelines) -- use the `scikit-learn` skill
- Statistical analysis and hypothesis testing -- use the `statistical-analysis` skill
