...
- `scikit-learn` skill -- Feature engineering with sklearn transformers after groupby analysis
- `exploratory-data-analysis` skill -- Distribution analysis using groupby patterns
